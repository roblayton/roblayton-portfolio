   ...
   */
     ...
     */
       ...
       */
			compile_js: {
				...
				src: ['<%= vendor_files.js %>', 'module.prefix', '<%= build_dir %>/src/**/*.js', '!<%= build_dir %>/src/**/*.fixture.js', '<%= html2js.app.dest %>', '<%= html2js.common.dest %>', '<%= vendor_files.js %>', 'module.suffix'],
     ...
     */
		jshint: {
			...
			fixture: ['<%= app_files.jsfixture %>'],
			scenario: ['<%= app_files.jsscenario %>'],
